<template>
  <div class="page-home">
    ...
    <section class="page-section-wrap">
      <textarea class="input-textarea" v-model="textStore" placeholder="输入你的文字, 聆听心的声音"></textarea>
    </section>
    <p class="input-tips">'键盘' 既是电脑的键盘⌨️也是钢琴的键盘🎹, 系统根据输入英文单词匹配 Major Chord, 试试随意输入一段文字,听听你自己演奏的声音.</p>
...
.page-home { width: 100%; min-width: 1080px; min-height: 100%; padding: 1px; padding-bottom: 150px; font-family: 'Avenir', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; color: @textdark;  position: absolute; top: 0; left: 0;
  ...
  .page-section-wrap { width: 100%; padding: 10px 40px; display: flex; align-items: center; justify-content: space-around; }
  .input-tips {
    text-align: center;
    color: #999999;
    font-size: 12px;
